                                ...
                                <CardContent className="pt-4 space-y-2">
                                    {citizen.HouseholdHelp.map((staff: any, i: number) => (
                                        <div key={i} className="border p-2 rounded flex justify-between items-start">
                                            ...
                                            {staff.idProofUrl && (
                                                <Button size="sm" variant="ghost" className="h-6 text-xs text-blue-600" onClick={() => window.open(staff.idProofUrl, '_blank')}>View ID</Button>
                                            )}
                                        </div>
                                    ))}
                                </CardContent>
                                ...
                                <CardContent className="pt-4 space-y-3">
                                    {citizen.addressProofUrl && (
                                        <div className="flex justify-between items-center border-b pb-2 last:border-0 last:pb-0">
                                            ...
                                            <Button variant="outline" size="sm" className="h-7 text-xs" onClick={() => window.open(citizen.addressProofUrl, '_blank')}>
                                                Preview
                                            </Button>
                                        </div>
                                    )}
                                    {citizen.idProofUrl && (
                                        <div className="flex justify-between items-center border-b pb-2 last:border-0 last:pb-0">
                                            ...
                                            <Button variant="outline" size="sm" className="h-7 text-xs" onClick={() => window.open(citizen.idProofUrl, '_blank')}>
                                                Preview
                                            </Button>
                                        </div>
                                    )}
