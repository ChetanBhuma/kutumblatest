...
async function runUAT() {
    ...
    try {
        ...
        await database_1.prisma.user.deleteMany({ where: { email: uatUserEmail } });
        await database_1.prisma.role.deleteMany({ where: { code: uatRoleCode } });
        ...
        try {
            await axios_1.default.get(`${API_URL}/citizens?limit=1`, {
        ...
        try {
            await axios_1.default.get(`${API_URL}/visits?limit=1`, {
                headers: { Authorization: `Bearer ${uatToken}` }
            });
        ...
        await database_1.prisma.role.update({
        ...
        const reloginRes = await axios_1.default.post(`${API_URL}/auth/login`, {
            identifier: uatUserEmail,
            password: uatUserPassword
        });
...
runUAT();
//# sourceMappingURL=uat-rbac.js.map