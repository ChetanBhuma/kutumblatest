...
class ExportService {
    ...
    static async generateCitizensCSV(citizens) {
        ...
        citizens.forEach(c => {
            ...
            if (c.PoliceStation?.name)
                c.PoliceStation.name = sanitize(c.PoliceStation.name);
            if (c.PoliceStation?.District?.name)
                c.PoliceStation.District.name = sanitize(c.PoliceStation.District.name);
        });
