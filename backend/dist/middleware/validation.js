...
exports.sanitizeInput = exports.ValidationRules = void 0;
...
class ValidationRules {
     ...
     */
    static aadhaar() {
        return (0, express_validator_1.body)('aadharNumber')
            .optional()
            .trim()
            .matches(/^\d{12}$/)
     ...
     */
    static latitude() {
        return (0, express_validator_1.body)('latitude')
            .optional()
     ...
     */
    static longitude() {
        return (0, express_validator_1.body)('longitude')
            .optional()
