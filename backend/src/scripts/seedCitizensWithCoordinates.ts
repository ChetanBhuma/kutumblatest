...
function getRandomCoordinateNear(lat: number, lng: number, radiusKm: number = 2) {
...
function getRandomAge(min: number = 60, max: number = 90): number {
            ...
            for (let i = 0; i < citizenCount; i++) {
                ...
                const citizen = await prisma.seniorCitizen.create({
                    data: {
                        ...
                        idVerificationStatus: getRandomElement(verificationStatuses) as IdentityStatus,
