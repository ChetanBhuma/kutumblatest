...
import { CheckCircle2, ChevronRight, ChevronLeft, Loader2, Upload, MapPin, Camera, X, User, Plus, Trash2, Eye } from 'lucide-react';
            ...
            try {
                ...
                if (res.success && res.data.citizen) {
                    ...
                    setFormData((prev: any) => ({
                        ...
                        addressLine1: c.addressLine1 || (c.permanentAddress === 'Pending Update' ? '' : c.permanentAddress?.split(',')[0]) || '',
